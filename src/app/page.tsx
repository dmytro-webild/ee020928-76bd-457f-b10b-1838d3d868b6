...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BfFkPfVLuI6a5BErkD9FBS3Zc3/portrait-of-a-happy-homeowner-smiling-in-1775155461753-71516099.png",
          alt: "Customer profile",
        },
        {
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BfFkPfVLuI6a5BErkD9FBS3Zc3/portrait-of-a-business-owner-standing-co-1775155463827-34c63d3f.png",
          alt: "Customer profile",
        },
        {
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BfFkPfVLuI6a5BErkD9FBS3Zc3/portrait-of-an-elderly-couple-happy-with-1775155463471-3c87554c.png",
          alt: "Customer profile",
        },
        {
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BfFkPfVLuI6a5BErkD9FBS3Zc3/portrait-of-a-busy-professional-standing-1775155461772-be546e05.png",
          alt: "Customer profile",
        },
        {
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BfFkPfVLuI6a5BErkD9FBS3Zc3/portrait-of-a-young-family-happy-outside-1775155461906-2863ea2d.png",
          alt: "Customer profile",
        },
      ]}
      avatarText="Trusted by 1500+ local homeowners"
      marqueeItems={[
        {
          type: "text-icon",
          text: "Storm Damage Certified",
          icon: Cloud,
        },
        {
          type: "text-icon",
        ...
        {
          type: "text-icon",
          text: "5-Star Local Rated",
          icon: Star,
        },
        {
          type: "text-icon",
          text: "Expert Claim Support",
          icon: ListChecks,
        },
        {
          type: "text-icon",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "Does my insurance cover storm damage?",
          content: "Yes, standard policies typically cover wind and hail damage. We specialize in documenting these claims.",
        },
        {
          id: "2",
          title: "How long does a full roof replacement take?",
          content: "Most residential replacements take 1-2 days depending on the size and complexity of your home.",
        },
        {
          id: "3",
          title: "What kind of warranty do you provide?",
          content: "We offer industry-leading workmanship guarantees in addition to manufacturer material warranties.",
        },
      ]}
      sideTitle="Expert Answers for Your Peace of Mind"
      sideDescription="We believe transparency is key to roofing excellence. Get clarity on claims, costs, and care."
  ...
  <div id="contact" data-section="contact">
      ...
      faqs={[
        {
          id: "1",
          title: "Do I need to be home for the inspection?",
          content: "No, we can perform a full roof evaluation safely while you're at work.",
        },
        {
          id: "2",
          title: "Is the inspection really free?",
          content: "Absolutely. There's zero cost or obligation for our assessment.",
        },
      ]}
